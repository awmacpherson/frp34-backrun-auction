...
Generally, only one arbitrage transaction is needed to reset the price after a price-moving trade.
%
...
In this paper we consider an idealised trading venue $\market$ on which two classes of trader place orders to exchange a risky asset with a num\'eraire:
\begin{itemize}
...
\begin{figure}[!ht]
  ...
  \node  (9) at  (1, 1.75) {};
  \node [label=below:$p_2+I(r_3)$] (10) at (2, 1) {};
  \node  (11) at (3, 2) {};
  \node  (12) at (-4, 4) {};
...
\begin{theorem}[Existence and convergence of equilibrium prices]
...
\begin{corollary}[Myopic arbitrageurs provide passthrough pricing]
...
\begin{theorem}[Zeta function approximation to manipulation coefficient]
...
\begin{corollary} \label{dominant-strategy-passthrough}
...
\begin{proposition}[Zeta function approximation for price manipulation factor]
